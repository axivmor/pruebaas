      ...
      <div class="col-lg-12 col-xs-12">
        <div class="alert alert-info alert-dismissable">
          ...
          <p style="font-size:15px">
            <i class="icon fa fa-user"></i> Bienvenido <strong><?php echo $_SESSION['name_user']; ?></strong> al sistema de gestion de academias.
          </p>        
        </div>
      </div>  
    </div>
    ...
    <div class="row">
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00c0ef;color:#fff" class="small-box">
          <div class="inner">
            ...
            $query = mysqli_query($mysqli, "SELECT COUNT(codigo) as numero FROM alumno")
          ...
          if ($_SESSION['permisos_acceso']!='gerente') { ?>
            <a href="?module=form_alumnos&form=add" class="small-box-footer" title="Agregar" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
          <?php
          } else { ?>
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00c0ef;color:#fff" class="small-box">
          ...
          <?php  
          if ($_SESSION['permisos_acceso']!='Gerente') { ?>
            <a href="?module=form_user&form=add" class="small-box-footer" title="Agregar" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
          <?php
          } else { ?>
            <a class="small-box-footer"><i class="fa"></i></a>
          <?php
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00a65a;color:#fff" class="small-box">
          ...
          <?php  
          if ($_SESSION['permisos_acceso']!='gerente') { ?>
            <a href="?module=form_alumno_transaction&form=add" class="small-box-footer" title="Agregar" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
          <?php
          } else { ?>
            <a class="small-box-footer"><i class="fa"></i></a>
          <?php
