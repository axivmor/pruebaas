...
if ($_SESSION['permisos_acceso']=='Super Admin') { ?>
  ...
  if ($_GET["module"]=="alumnos" || $_GET["module"]=="form_alumnos") { ?>
    <li class="active">
      <a href="?module=alumnos"><i class="fa fa-folder"></i> Datos de alumnos </a>
      </li>
  <?php
  }
  ...
  if ($_GET["module"]=="alumno_transaction" || $_GET["module"]=="form_alumno_transaction") { ?>
    <li class="active">
      <a href="?module=alumno_transaction"><i class="fa fa-clone"></i> Pagos </a>
      </li>
  <?php
  }
