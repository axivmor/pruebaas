...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Panel de administración | INTECOM</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Sistema de gestión de alumnos">
    <meta name="author" content="Sistemade Gestion - INTECOM" />
    
    <!-- logo intecom -->
    <link rel="shortcut icon" href="assets/img/logo_intecom.jpg" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-15px;margin-right:5px" src="assets/img/logo_intecom.jpg" alt="Logo" height="50"> 
          <span style="font-size:20px">INTECOM</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="https://www.facebook.com/profile.php?id=100002208069190" target="_blank">INTECOM GUASTATOYA</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
